...
class Rectangle(Base):
    ...
    def __init__(self, width, height, x=0, y=0, id=None):
        ...
        **Raises:**
            `TypeError`: If either of `width` or `height` is not an
                        integer.
    ...
    def update(self, *args, **kwargs):
        ...
        Args:
            *args: New attribute values.
                - arg1 : id attribute
                - arg2 (int): width attribute
                - arg3 (int): height attribute
                - arg4 (int): x attribute
                - arg5 (int): y attribute
    ...
    def to_dictionary(self):
        """Return the dictionary of th Rectangle."""
        return {
            "id": self.id,
            "width": self.width,
            "height": self.height,
